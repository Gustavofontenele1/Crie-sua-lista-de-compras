...
- Adicionar tarefas: Digite o texto da tarefa no campo de entrada e clique no botão "<img src="assets/img/carrinho-de-compras2.gif" alt="Link para o GitHub Pages" class="animated-link">" para adicionar uma nova tarefa.
